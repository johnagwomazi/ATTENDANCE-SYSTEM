...
export const AuthForm = ({ control, errors, fields, submitLabel, onSubmit, secondaryAction }) => {
  return (
    <form onSubmit={onSubmit} className="w-full max-w-md rounded-[28px] border border-border bg-surface p-5 shadow-soft sm:p-6 md:p-8">
      <div className="mb-7 sm:mb-8">
        <p className="text-xs font-bold uppercase tracking-[0.24em] text-orange">New Horizons</p>
        <h2 className="mt-3 text-2xl font-extrabold tracking-tight text-text sm:text-3xl">{submitLabel}</h2>
