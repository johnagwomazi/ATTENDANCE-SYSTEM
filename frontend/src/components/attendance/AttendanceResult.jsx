...
export const AttendanceResult = ({ result }) => {
    ...
    return (
      <motion.div initial={{ scale: 0.96, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="mx-auto max-w-xl">
        <Card className="p-5 text-center sm:p-6 md:p-8">
          ...
          <h3 className="mt-6 text-xl font-extrabold text-text sm:text-2xl">Attendance Recorded</h3>
  ...
  if (result.type === 'expired_program') {
    return (
      <Card className="mx-auto max-w-xl p-5 sm:p-6 md:p-8">
        ...
        <h3 className="mt-5 text-2xl font-extrabold text-text sm:text-3xl">Your program has ended.</h3>
  ...
  return (
    <Card className="mx-auto max-w-xl p-5 sm:p-6 md:p-8">
      ...
      <h3 className="mt-5 text-2xl font-extrabold text-text sm:text-3xl">{result.message || 'You do not have a class today.'}</h3>
      <p className="mt-3 max-w-lg text-sm leading-7 text-slate-500">
