...
import { create, list, read, remove, update } from '../controllers/scheduleController.js';
...
router.post('/', createScheduleValidation, validateRequest, create);
router.get('/', list);
router.get('/:id', idParamValidation, validateRequest, read);
router.put('/:id', idParamValidation, updateScheduleValidation, validateRequest, update);
